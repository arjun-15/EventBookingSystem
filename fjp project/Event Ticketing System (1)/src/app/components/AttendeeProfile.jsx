...
import { ArrowLeft, Download, Share2, Calendar, MapPin, QrCode, Loader2 } from 'lucide-react';
...
export const AttendeeProfile = ({ onNavigate }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 md:p-8">
            <div className="premium-card p-8 mb-8 bg-white overflow-hidden relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-purple-50 rounded-full -mr-32 -mt-32 opacity-50"></div>
                <div className="relative flex flex-col md:flex-row items-center gap-6">
                    <div className="w-24 h-24 bg-gradient-to-br from-purple-600 to-indigo-700 rounded-3xl flex items-center justify-center text-white text-4xl font-black shadow-xl shadow-purple-200">
                        {user?.name?.[0]?.toUpperCase()}
                    </div>
                    <div className="text-center md:text-left flex-1">
                        <div className="flex flex-col md:flex-row md:items-center gap-2 md:gap-4 mb-2">
                            <h1 className="text-3xl font-black text-gray-900">{user?.name}</h1>
                            <span className="inline-flex items-center px-3 py-1 bg-purple-100 text-purple-700 text-xs font-bold uppercase tracking-widest rounded-full w-fit mx-auto md:mx-0">
                                {user?.role}
                            </span>
                        </div>
                        ...
                        <div className="flex flex-wrap justify-center md:justify-start gap-4">
                            ...
                            <div className="px-4 py-2 bg-gray-50 rounded-xl border border-gray-100">
                                ...
                                <p className="text-lg font-bold text-green-600 flex items-center justify-center md:justify-start gap-1">
                    ...
                    <button
                        ...
                        className="px-6 py-2 border border-gray-200 rounded-xl text-sm font-bold text-gray-600 hover:bg-gray-50 transition-all active:scale-95"
                    >
                        Edit Profile
                    </button>
                </div>
            ...
            <div className="mt-8">
                <div className="mb-8">
                    <h2 className="text-3xl font-black text-gray-900 mb-2">My Tickets</h2>
                    <p className="text-gray-600 font-medium">View and manage your booked tickets</p>
                </div>
