...
import { Search, Filter, Calendar, MapPin, IndianRupee, Share2, LogOut, User, LayoutDashboard, Loader2 } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-gray-500">Loading amazing events for you...</p>
                    </div>
                ) : (
                    <>
