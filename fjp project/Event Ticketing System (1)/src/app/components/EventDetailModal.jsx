        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 overflow-y-auto">
            <div className="bg-white rounded-2xl max-w-4xl w-full my-8 max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-6">
                    ...
                    {!showCheckout ? (
                        <div>
                            <h3 className="text-xl font-bold mb-6 text-purple-900 border-b pb-2">CHOOSE YOUR TICKET</h3>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                                {event.ticketTiers.map((tier) => (
                                    <div
                                        key={tier.id}
                                        className="flex flex-col h-full border-2 border-gray-100 rounded-3xl p-8 hover:border-purple-600 transition-all duration-300 bg-white shadow-sm hover:shadow-xl"
                                    >
                                        <div className="flex-grow">
                                            <span className="inline-block px-3 py-1 bg-purple-50 text-purple-600 text-[10px] font-bold uppercase tracking-widest rounded-full mb-4">
                                                Tier Option
                                            </span>
                                            ...
                                            <div className="flex items-baseline gap-1 mb-6">
                                                ...
                                                <span className="text-gray-400 text-xs font-medium">/ person</span>
                                            </div>
                                            <ul className="space-y-4 mb-8">
                                                {tier.features.map((feature, index) => (
                                                    <li key={index} className="flex items-start gap-3 text-sm text-gray-600 leading-tight">
                                                        <div className="mt-1 w-4 h-4 bg-green-100 text-green-600 rounded-full flex items-center justify-center flex-shrink-0">
                                        ...
                                        <div className="mt-auto pt-6 border-t border-gray-50">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <span className="text-xs font-bold text-purple-600 bg-purple-50 px-2 py-0.5 rounded">
                                                    {tier.available} / {tier.total} left
                                                </span>
                                            </div>
                                            <button
                                                onClick={() => handleSelectTier(tier)}
                                                disabled={tier.available === 0 || user?.role !== 'attendee'}
                                                className="w-full py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-2xl transition-all duration-300 font-bold shadow-lg shadow-purple-100 active:scale-[0.97] disabled:bg-gray-200 disabled:shadow-none disabled:text-gray-400"
                                            >
